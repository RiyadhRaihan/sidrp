...
<head>
    ...
    <link rel="shortcut icon"
        href="{{ asset('style/assets/images/logo-atau-lambang-kabupaten-bogor-transparan-png-96x119.png') }}"
        type="image/x-icon">
...
<body>
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="/">
                            <img src="{{ asset('style/assets/images/logo-atau-lambang-kabupaten-bogor-transparan-png-96x119.png') }}"
                                alt="Mobirise" style="height: 3rem;">
                        </a>
                    </span>
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-black text-primary display-4"
                            href="/">Sistem Informasi Desa Rawapanjang<br></a></span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        <li class="nav-item">
                            <a class="nav-link link text-black text-primary show display-4" href="layanan"
                                data-bs-auto-close="outside" aria-expanded="true">Layanan</a>
                        </li>
                        <li class="nav-item"><a class="nav-link link text-black text-primary show display-4"
                                href="kegiatan" data-bs-auto-close="outside" aria-expanded="true">Kegiatan</a></li>
                        <li class="nav-item"><a class="nav-link link text-black text-primary show display-4"
                                href="about" data-bs-auto-close="outside" aria-expanded="true">Tentang Kami</a></li>

                        <li class="nav-item"><a class="nav-link link text-black text-primary display-4"
                                href="contact">Kontak Kami</a></li>
                    </ul>
    ...
    <script src="{{ asset('style/assets/mbr-testimonials-slider/mbr-testimonials-slider.js') }}"></script>
